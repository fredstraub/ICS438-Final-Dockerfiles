Dockerfile for image that only has the appllicaiton from the final project.  The app.py file is the app code.  It is supposed ot be accessible from port 8050.
